...
const formURL = "http://localhost:5000/removeWord/remove"
      ...
      {({isSubmitting, errors, touched, setFieldValue}) => (
        <Form>
					<div>
						...
						<div>
							<Button id = "input-words-delete" fullWidth variant="outlined" color = "primary" type="submit" disabled={isSubmitting}>
								Clear
							</Button>
						</div>
					</div>
